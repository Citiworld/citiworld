...
export function ProductsLayout({ title, form, children }: ProductLayoutProps) {
	return (
		<div className="relative">
			<Pipe2 className={styles['asset'] + ' lt-xs:hidden w-28 sm:w-40 md:w-56 xl:w-72'} />
			<Pipe2 className={styles['asset'] + ' lt-xs:hidden w-28 sm:w-40 md:w-56 xl:w-72 right-0 -scale-x-100'} />
