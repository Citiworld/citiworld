...
export function MobileNavBar() {
	...
	return (
		<NavigationMenu.Root className="lg:hidden">
			<NavigationMenu.List>
				<NavigationMenu.Item>
					<NavigationMenu.Trigger className="outline-2 outline-solid outline-transparent hover:outline-primary-300 hover:bg-primary-100 transition-colors rounded-lg cursor-default">
						<span className="i-material-symbols-menu-rounded text-4xl" />
